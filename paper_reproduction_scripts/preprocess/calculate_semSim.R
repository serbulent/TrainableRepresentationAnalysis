...
calculate_similarities <- function(ontology_type){
	...
	input_file_tmp= cbind('/media/DATA/serbulent/DATA/Thesis/ReviewPaper/preprocess/results/human_all_well_annotated_proteins_accession_ids.tsv')
	...
	output_file_tmp = cbind("human",ontology_type,"proteinSimilarityMatrix_for_all_proteins_04_12_2020.csv")
