...
def score_protein_rep():
    ...
    report.to_csv('../results/dt_prot_famliy_pred_'+representation_name+'_report_class_based_nc.csv',index=False)
    
    #print(report)
    if detailed_output:
        save('../results/drug_target_family_pred_f1_perclass_'+ representation_name +'_nc.npy', f1_perclass)
        save('../results/drug_target_family_pred_accuracy_perclass_'+ representation_name +'_nc.npy', accurac_perclass)
        save('../results/drug_target_family_pred_mcc_perclass_'+ representation_name +'_nc.npy', mcc_perclass) 
