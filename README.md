...
**generalized_representation_benchmark** folder. Anyone can test his/her own representation model with this tool. Also study results can be reproduced easily using ProtBench.
