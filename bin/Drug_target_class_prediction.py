...
#def score_protein_rep(pkl_data_path):
    ...
    conf.to_csv('../results/target_family_classification_confusion_'+dataset+'_'+representation_name+'.csv', index=None)
    ...
    report_list.to_csv('../results/family_classification_class_based_results_'+dataset+'_'+representation_name+'.csv')
    ...
    report.to_csv('../results/family_classification_mean_results_'+dataset+'_'+representation_name+'.csv',index=False)
    #report.to_csv('scores_general.csv')
    #print(report)   
    if detailed_output:
        save('../results/drug_target_family_pred_f1_'+dataset+'_'+representation_name+'.npy', f1)
        save('../results/drug_target_family_pred_accuracy_'+dataset+'_'+representation_name+'.npy', accuracy)
        save('../results/drug_target_family_pred_mcc_'+dataset+'_'+representation_name+'.npy', mcc) 
        save('../results/drug_target_family_pred_class_based_f1_'+dataset+'_'+representation_name+'.npy', f1_perclass)
        save('../results/drug_target_family_pred_class_based_accuracy_'+dataset+'_'+representation_name+'.npy', ac_perclass)
        save('../results/drug_target_family_pred_class_based_mcc_'+dataset+'_'+representation_name+'.npy', mcc_perclass) 
        save('../results/drug_target_family_pred_class_based_support_'+dataset+'_'+representation_name+'.npy', sup_perclass) 
